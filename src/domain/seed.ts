 ...
 * imported statement.
 *
 * Every counterparty here is invented. That is not incidental: the demo is what
 * appears in screenshots and in the submission video, and the contest rules
 * exclude third-party trademarks. Naming a real business beside a row headed
 * "paid the same amount twice" would also imply something about that business
 * which is not true of it.
 *
...
const ROWS: Row[] = [
  { date: '2026-01-02', description: 'UPI-QUICKBITE DELIVERY-QUICKBITE@AXISBANK', reference: '600112233445', amount: '-412.00' },
  ...
  { date: '2026-01-07', description: 'UPI-ROASTERY LANE COFFEE-ROASTERYLANE@HDFCBANK', reference: '600112233611', amount: '-680.00' },
  { date: '2026-01-09', description: 'NEFT CR-HDFC0000123-NORTHWIND SALARY', reference: 'HDFCN52200914', amount: '84000.00' },
  { date: '2026-01-11', description: 'UPI-GREENMART RETAIL LIMITED-RELRETAIL@YBL', reference: '600112233712', amount: '-1899.00' },
  ...
  { date: '2026-01-25', description: 'UPI-QUICKBITE DELIVERY-QUICKBITE@AXISBANK', reference: '600112234140', amount: '-528.00' },
  ...
  { date: '2026-02-02', description: 'UPI-QUICKBITE DELIVERY-QUICKBITE@AXISBANK', reference: '600112234260', amount: '-389.00' },
  ...
  { date: '2026-02-14', description: 'UPI-ROASTERY LANE COFFEE-ROASTERYLANE@HDFCBANK', reference: '600112234488', amount: '-540.00' },
  ...
  { date: '2026-02-25', description: 'UPI-GREENMART RETAIL LIMITED-RELRETAIL@YBL', reference: '600112234720', amount: '-2310.00' },
  ...
  { date: '2026-03-22', description: 'UPI-QUICKBITE DELIVERY-QUICKBITE@AXISBANK', reference: '600112235090', amount: '-455.00' },
]
